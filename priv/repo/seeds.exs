...
DbProject.Repo.insert!(%DbProject.Accounts.User{name: "Michał Dziardziel", email: "michal.dziardziel@akai.org.pl", roles: [%DbProject.Accounts.Role{name: "Member admin", atom: "member_admin"}]})
